...
from gym_pybullet_drones.envs.single_agent_rl.ToPointAviary import ToPointAviary
...
DEFAULT_CPU = 4
DEFAULT_STEPS = 100000 #3500
DEFAULT_OUTPUT_FOLDER = 'results-topint'
...
def run(
    ...
    if env_name == "topoint-aviary-v0":
        train_env = make_vec_env(ToPointAviary,
                                 env_kwargs=sa_env_kwargs,
                                 n_envs=cpu,
                                 seed=0
                                 )
    ...
    if obs == ObservationType.KIN: 
        ...
        if env_name == "topoint-aviary-v0":
            eval_env = make_vec_env(ToPointAviary,
                                    env_kwargs=sa_env_kwargs,
                                    n_envs=1,
                                    seed=0
                                    )

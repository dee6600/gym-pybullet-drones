...
DEFAULT_CPU = 4
DEFAULT_STEPS = 4 * int(1e6)
DEFAULT_OUTPUT_FOLDER = 'results-hover-proploss-test-ppo-final-test'
...
def run(
    ...
    if DEFAULT_RETRAIN:
        model = PPO.load("/Users/dee/Documents/projects/RLMultiRoter/gym-pybullet-drones/experiments/learning/results-hover-proploss-test/save-hover-ppo-kin-rpm-11.17.2022_17.28.09/best_model", tensorboard_log='/Users/dee/Documents/projects/RLMultiRoter/gym-pybullet-drones/experiments/learning/results-hover-proploss-test/save-hover-ppo-kin-rpm-11.17.2022_18.54.30')

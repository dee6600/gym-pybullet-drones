...
def run(rllib=DEFAULT_RLLIB,output_folder=DEFAULT_OUTPUT_FOLDER, gui=DEFAULT_GUI, plot=True, colab=DEFAULT_COLAB, record_video=DEFAULT_RECORD_VIDEO):
    ...
    model = PPO.load("/Users/dee/Documents/projects/RLMultiRoter/gym-pybullet-drones/experiments/learning/results-hover-proploss-test-ppo-final-test/save-hover-ppo-kin-rpm-11.28.2022_02.23.47/best_model.zip")
    #model = PPO.load("/Users/dee/Documents/projects/RLMultiRoter/gym-pybullet-drones/best_model")

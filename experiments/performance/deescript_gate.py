...
def run(rllib=DEFAULT_RLLIB,output_folder=DEFAULT_OUTPUT_FOLDER, gui=DEFAULT_GUI, plot=True, colab=DEFAULT_COLAB, record_video=DEFAULT_RECORD_VIDEO):
    ...
    model = PPO.load("/Users/dee/Documents/projects/RLMultiRoter/gym-pybullet-drones/experiments/learning/results-gate-test/save-flythrugate-ppo-kin-rpm-11.05.2022_13.45.17/best_model")
    ...
    #### Save the model ########################################
    # if not rllib:
    #     model.save(output_folder + "/save-takeoff-a2c")
    # else:
    #     policy.save_model(output_folder + "/save-takeoff-ppo")
